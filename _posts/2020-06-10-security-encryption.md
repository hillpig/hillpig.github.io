...
comments: true
---
![img](https://blog.shikisoft.com/assets/images/post_imgs/aws-all-5-certifications.png)
...
[参考](https://aws.amazon.com/cn/certificate-manager/)

## Routing policies and BGP communities

[参考](https://docs.aws.amazon.com/directconnect/latest/UserGuide/routing-and-bgp.html)

## Meet the Recovery Time Objective (RTO) &  the Recovery Point Objective (RPO) 

[参考](https://www.itprotoday.com/backup/what-you-need-know-about-rpo-and-rto)

## AWS Compliance

[参考](https://docs.aws.amazon.com/whitepapers/latest/aws-overview/security-and-compliance.html)
...
[www.examtopics.com](https://www.examtopics.com/exams/amazon/aws-certified-solutions-architect-professional/view/)
...
- [x] E. AWS CloudFormation with Lambda Custom Resources running in a VPC for the web application, and an Amazon RDS for MySQL database.
